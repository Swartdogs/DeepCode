...
GrpRocketRightL2::GrpRocketRightL2() {
  ...
  AddSequential (new CmdDriveDistance(75, 35, 0.5, 0, true, false, 4.0));
  ...
  AddSequential (new CmdDriveRotate(160, 0.8, false, 2.0));
  AddSequential (new CmdDriveDistance(66, 160, 0.8, 0, true, false, 4.0));
  AddSequential (new CmdDriveRotate(175, 0.8, false, 2.0));
  AddSequential (new CmdVisionFindTarget(Vision::tsBest));
  ...
  AddSequential (new CmdDriveDistance(-90, 160, 0.7, 0, true, false, 3.5)); 
}
