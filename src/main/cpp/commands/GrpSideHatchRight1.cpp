...
GrpSideHatchRight1::GrpSideHatchRight1(double distance1, double maxSpeed1) {
  ...
  AddSequential (new CmdDriveDistance(-30, -90, 0.7, 0, true, true, 2.0));
  ...
  AddSequential (new CmdDriveDistance(-90, -188, 0.7, 0, true, true, 3.5));
}
