...
GrpSideHatchLeft::GrpSideHatchLeft(double distance1, double maxSpeed1) {
  ...
  AddSequential (new CmdDriveRotate(194, 0.8, false, 2.0));
  AddSequential (new CmdDriveDistance(162, 194, 0.8, 0, true, false, 4.5)); 
